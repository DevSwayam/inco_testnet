      ...
      <section>
        {isToken ? (
          <div className="backdrop:blur-sm h-screen flex flex-col items-center justify-center gap-2">
            <p className="text-xl">Received Tokens Sucessfully</p>
            <button
            ...
            <div className="relative pt-32 pb-5 md:pt-40 md:pb-16">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                ...
                <p
                  ...
                  data-aos-delay="200"
                >
                  This will give you 0.5 inco faucet. Just put your address
                  below or connect wallet ↗
                </p>
                <div
                ...
                >
                  <form className="w-full">
                    <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
                      <input
                        type="text"
                        className="md:w-3/4 appearance-none bg-purple-700 border border-purple-500 focus:border-purple-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-purple-400"
